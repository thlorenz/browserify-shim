...
test('when I shim a library expecting this === window', function (t) {
  entry = require.resolve('./fixtures/entry-requires-this-iife.js')
  file = require.resolve('./fixtures/shims/this-iife.js')
  ...
  browserify(entry)
    ...
    .bundle(function (err, src) {
      ...
      ctx.self = ctx.window;
      var require_ = vm.runInNewContext(src, ctx);
      t.equal(typeof require_(1).update, 'function', 'passes window as this')
      t.end()
    })
})
